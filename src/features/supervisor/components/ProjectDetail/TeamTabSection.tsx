...
export function TeamTabSection({ project, team }: TeamTabSectionProps) {
  return (
    <section className="rounded-3xl border border-border bg-white p-6 shadow-sm transition-all hover:shadow-md">
      ...
      {project.leader ? (
        <div className="mt-6 overflow-hidden rounded-3xl border border-emerald-100 bg-emerald-50/30 p-6 shadow-sm animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="flex shrink-0 items-center justify-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-100 text-base font-black text-emerald-600 shadow-inner">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold uppercase tracking-wider text-emerald-700">Project Leader</h3>
              </div>
              <p className="mt-1 truncate text-lg font-black tracking-tight text-slate-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={buttonStyles({ 
                      variant: 'primary', 
                      size: 'sm',
                      className: 'rounded-xl h-10 bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-100'
                    })}
                  >
        ...
        <div className="mt-6 overflow-hidden rounded-3xl border border-dashed border-slate-200 bg-slate-50/50 p-8 text-center animate-in fade-in zoom-in-95 duration-300">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-slate-100">
            <Crown className="h-7 w-7 text-slate-300" />
          </div>
          <h3 className="mt-4 text-base font-black text-slate-800">No project leader assigned</h3>
          <p className="mt-2 text-sm font-medium text-slate-400">Assign a student to lead this project</p>
          ...
          {team.studentMembers.length > 0 ? (
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-xs font-black uppercase tracking-widest text-slate-400">
      ...
      {team.isManagingStudents && (
        <div className="mt-6 overflow-hidden rounded-3xl border border-indigo-100 bg-indigo-50/20 p-6 shadow-sm animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="mb-5 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-indigo-100 text-indigo-600">
              <UserPlus className="h-5 w-5" />
            </div>
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider text-indigo-700">Add Team Members</h3>
              <p className="text-xs font-medium text-indigo-500/70">Search and assign students to this project</p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap justify-end gap-3 border-t border-indigo-100 pt-6">
            <button
              type="button"
              className={buttonStyles({ variant: 'secondary', size: 'md', className: 'rounded-xl' })}
            ...
            <button
              type="button"
              className={buttonStyles({ variant: 'primary', size: 'md', className: 'rounded-xl shadow-lg shadow-indigo-100' })}
