  ...
  return (
    <section className="flex min-h-screen flex-col items-center justify-center px-6 pt-[var(--nav-height)]">
      <div className="mx-auto max-w-4xl text-center">
        <div className="mb-6 inline-flex items-center rounded-full border border-border bg-muted px-4 py-1.5 text-xs font-medium text-muted-foreground">
          Now in Public Beta
        </div>
        <h1 className="mb-8 text-6xl font-bold leading-tight tracking-tight text-foreground sm:text-7xl">
          Streamline Your <span className="gradient-text">Research Supervision.</span>
        </h1>
        <p className="mx-auto mb-12 max-w-xl text-xl leading-relaxed text-muted-foreground">
