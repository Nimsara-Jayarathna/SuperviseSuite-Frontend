...
Commit range: `fe07054` -> `7c7271c`  
Merge reference: `e66e5dc` (PR #31 into `dev`)

## Fix 1: Guided Repository Linking in Supervisor Project Details
...
## Fix 2: Project-Scoped Request-Access Callback UX
...
## Fix 3: Shared GitHub Activity Components Aligned with V2 Linking
...
## Fix 4: Type and API Contract Alignment
