...
| [features/supervisor.md](features/supervisor.md) | Supervisor routes, dashboard, projects, detail views, Integrations/Jira tab behavior, guided GitHub linking, and project-scoped request-access callbacks |
